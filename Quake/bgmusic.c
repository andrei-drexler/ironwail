...
#ifdef USE_CODEC_MP3
#define CDRIP_TYPES	(CODECTYPE_VORBIS | CODECTYPE_FLAC | CODECTYPE_WAV | CODECTYPE_OPUS | CODECTYPE_MP3)
#else
#define CDRIP_TYPES	(CODECTYPE_VORBIS | CODECTYPE_FLAC | CODECTYPE_WAV | CODECTYPE_OPUS)
#endif
